...
export const mat = (color, options={}) => new THREE.MeshStandardMaterial({color,roughness:.6,...options});
export const palette = {stone:mat(0xd5d4c7),edge:mat(0xe9e5d5),glass:mat(0x416678,{metalness:.68,roughness:.2}),dark:mat(0x213842,{metalness:.4,roughness:.35}),wood:mat(0xb79972),green:mat(0x50765a),leaf:mat(0x6e9168),cyan:mat(0x72d9da,{emissive:0x247a80,emissiveIntensity:.4}),white:mat(0xe0e8e7),blue:mat(0x458cb4),red:mat(0xbb7565),warm:mat(0xf4d7a6,{emissive:0xffc47a,emissiveIntensity:.18})};
const cube = new THREE.BoxGeometry(1,1,1);
export function box(parent,size,pos,material=palette.stone,name='') {const m=new THREE.Mesh(cube,material);m.scale.set(...size);m.position.set(...pos);m.name=name;m.castShadow=true;m.receiveShadow=true;parent.add(m);return m;}
export function cylinder(parent,r,h,pos,material=palette.dark,segments=12) {const m=new THREE.Mesh(new THREE.CylinderGeometry(r,r,h,segments),material);m.position.set(...pos);m.castShadow=true;m.receiveShadow=true;parent.add(m);return m;}
